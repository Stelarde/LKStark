...
class Version20210914144343 extends Version
{
    protected $description = "блок батарей 14.09";
  ...
  'EDIT_FORM_LABEL' => 
  array (
    'en' => 'Comment on the object',
    'ru' => 'Комментарий к объекту',
  ),
  'LIST_COLUMN_LABEL' => 
  array (
    'en' => 'Comment on the object',
  ...
  array (
    ...
    'ru' => '',
        ...
        $helper->Hlblock()->saveField($hlblockId, array (
  'FIELD_NAME' => 'UF_COMMENT_TYPE_EQUIPMENT',
  'USER_TYPE_ID' => 'string',
  'XML_ID' => '',
  'SORT' => '100',
  'MULTIPLE' => 'N',
  ...
  'EDIT_FORM_LABEL' => 
  array (
    'en' => 'Comment on the type of equipment',
    'ru' => 'Комментарий к виду техники',
  ),
  'LIST_COLUMN_LABEL' => 
  array (
    'en' => 'Comment on the type of equipment',
