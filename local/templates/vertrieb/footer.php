...
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/libs/swiper-bundle.min.js", true);
$APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH."/js/libs/datepicker.min.js", true);
